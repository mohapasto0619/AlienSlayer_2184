...
public class ScoreSharedPreferencesBackEnd implements ScoreBackEnd {
    ...
    public static String FILE_NAME = "scores_shared_preferences_file";
    public static String NAME_1_VALUE = "name_1_value";
    public static String NAME_2_VALUE = "name_2_value";
    public static String NAME_3_VALUE = "name_3_value";
    public static String NAME_4_VALUE = "name_4_value";
    public static String NAME_5_VALUE = "name_5_value";
    public static String NAME_6_VALUE = "name_6_value";
    public static String NAME_7_VALUE = "name_7_value";
    public static String NAME_8_VALUE = "name_8_value";
    public static String NAME_9_VALUE = "name_9_value";
    public static String NAME_10_VALUE = "name_10_value";
    public static String NAME_11_VALUE = "name_11_value";
    public static String SCORE_1_VALUE = "score_1_value";
    public static String SCORE_2_VALUE = "score_2_value";
    public static String SCORE_3_VALUE = "score_3_value";
    public static String SCORE_4_VALUE = "score_4_value";
    public static String SCORE_5_VALUE = "score_5_value";
    public static String SCORE_6_VALUE = "score_6_value";
    public static String SCORE_7_VALUE = "score_7_value";
    public static String SCORE_8_VALUE = "score_8_value";
    public static String SCORE_9_VALUE = "score_9_value";
    public static String SCORE_10_VALUE = "score_10_value";
    public static String SCORE_11_VALUE = "score_11_value";
}
