...
public class OptionsSharedPreferencesBackEnd implements OptionsBackEnd {
    ...
    public static String FILE_NAME = "options_shared_preferences_file";
    public static String MUSIC_FAV_VALUE = "music_fav_value";
    public static String SOUND_FAV_VALUE = "sound_fav_value";
    public static String SKIN_ID_FAV_VALUE = "skin_id_fav_value";
}
