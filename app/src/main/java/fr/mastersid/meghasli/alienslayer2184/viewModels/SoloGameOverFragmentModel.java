...
public class SoloGameOverFragmentModel extends ViewModel {
    public MutableLiveData<String> playerName = new MutableLiveData<>(DEFAULT_PLAYER_NAME);
    public MutableLiveData<Integer> playerScore = new MutableLiveData<>(DEFAULT_PLAYER_SCORE);
    Integer[] scoreBoard;
    String[] namesBoard;
